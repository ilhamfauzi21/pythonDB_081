...
matkul.configure(background="red") 
matkul.geometry("600x600") 
matkul.title("Prak") 
 
title_label = ttk.Label(matkul, text="Prediksi Prodi Kamu", font=("Times New Roman", 16)) 
...
def Prodi_Kamu(): 
    ...
    output_text = f"Prodi kamu adalah: {prediksi_fakultas}" 
